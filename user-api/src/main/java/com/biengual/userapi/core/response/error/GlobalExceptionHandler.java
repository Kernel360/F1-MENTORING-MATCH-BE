package com.biengual.userapi.core.response.error;

import com.biengual.userapi.core.response.ResponseEntityFactory;
import com.biengual.userapi.core.response.error.code.RequestErrorCode;
...
import static com.biengual.userapi.core.response.error.code.ServerError.SERVER_ERROR;
